    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                scm {
                    connection.set("scm:git:git://github.com/meorphis-test/test-repo-3.git")
                    developerConnection.set("scm:git:git://github.com/meorphis-test/test-repo-3.git")
                    url.set("https://github.com/meorphis-test/test-repo-3")
                }
