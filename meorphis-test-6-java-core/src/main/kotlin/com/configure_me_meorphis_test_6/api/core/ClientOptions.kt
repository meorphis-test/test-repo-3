...
import com.configure_me_meorphis_test_6.api.core.http.RetryingHttpClient
...
private constructor(
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.acme.com/v1"

        const val ENVIRONMENT_1_URL = "https://sandbox.acme.com/v1"
    ...
    class Builder {
        ...
        fun fromEnv() = apply { System.getenv("MEORPHIS_TEST_6_API_KEY")?.let { apiKey(it) } }
