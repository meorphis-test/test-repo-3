...
class AccountCreditConfigurationPatchAccountCreditConfigurationParams
constructor(
    ...
    @JsonDeserialize(
        builder = AccountCreditConfigurationPatchAccountCreditConfigurationBody.Builder::class
    )
    @NoAutoDetect
    class AccountCreditConfigurationPatchAccountCreditConfigurationBody
    internal constructor(
        ...
        override fun toString() =
            "AccountCreditConfigurationPatchAccountCreditConfigurationBody{billingPeriod=$billingPeriod, creditLimit=$creditLimit, externalBankAccountToken=$externalBankAccountToken, paymentPeriod=$paymentPeriod, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(
                accountCreditConfigurationPatchAccountCreditConfigurationBody:
                    AccountCreditConfigurationPatchAccountCreditConfigurationBody
            ) = apply {
                this.billingPeriod =
                    accountCreditConfigurationPatchAccountCreditConfigurationBody.billingPeriod
                this.creditLimit =
                    accountCreditConfigurationPatchAccountCreditConfigurationBody.creditLimit
                this.externalBankAccountToken =
                    accountCreditConfigurationPatchAccountCreditConfigurationBody
                        .externalBankAccountToken
                this.paymentPeriod =
                    accountCreditConfigurationPatchAccountCreditConfigurationBody.paymentPeriod
                additionalProperties(
                    accountCreditConfigurationPatchAccountCreditConfigurationBody
                        .additionalProperties
                )
            ...
            fun build(): AccountCreditConfigurationPatchAccountCreditConfigurationBody =
                AccountCreditConfigurationPatchAccountCreditConfigurationBody(
                    billingPeriod,
                    creditLimit,
                    externalBankAccountToken,
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.accountToken =
                accountCreditConfigurationPatchAccountCreditConfigurationParams.accountToken
            this.billingPeriod =
                accountCreditConfigurationPatchAccountCreditConfigurationParams.billingPeriod
            this.creditLimit =
                accountCreditConfigurationPatchAccountCreditConfigurationParams.creditLimit
            this.externalBankAccountToken =
                accountCreditConfigurationPatchAccountCreditConfigurationParams
                    .externalBankAccountToken
            this.paymentPeriod =
                accountCreditConfigurationPatchAccountCreditConfigurationParams.paymentPeriod
            additionalQueryParams(
                accountCreditConfigurationPatchAccountCreditConfigurationParams
                    .additionalQueryParams
            )
            additionalHeaders(
                accountCreditConfigurationPatchAccountCreditConfigurationParams.additionalHeaders
            )
            additionalBodyProperties(
                accountCreditConfigurationPatchAccountCreditConfigurationParams
                    .additionalBodyProperties
        ...
        fun build(): AccountCreditConfigurationPatchAccountCreditConfigurationParams =
            AccountCreditConfigurationPatchAccountCreditConfigurationParams(
