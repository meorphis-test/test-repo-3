...
constructor(
    ...
    internal constructor(
        ...
        /**
         * For card programs with more than one BIN range. This must be configured with Acme before
        ...
        /**
         * Only applicable to cards of type `PHYSICAL`. This must be configured with Acme before
        ...
        class Builder {
             ...
             * out at [acme.com/contact](https://acme.com/contact) for more information.
             * - `SINGLE_USE` - Card is closed upon first successful authorization.
             * - `MERCHANT_LOCKED` - _[Deprecated]_ Card is locked to the first merchant that
             * successfully authorizes the card.
             */
            ...
            /**
             * For card programs with more than one BIN range. This must be configured with Acme
            ...
            /**
             * Specifies the digital card art to be displayed in the user’s digital wallet after
             * tokenization. This artwork must be approved by Mastercard and configured by Acme to
             * use. See
             * [Flexible Card Art Guide](https://docs.acme.com/docs/about-digital-wallets#flexible-card-art)
             * .
             */
    ...
    private constructor(
        ...
        @JsonProperty("qr_code_url") fun qrCodeUrl(): String? = qrCodeUrl
        ...
        class Builder {
            ...
            fun qrCodeUrl(qrCodeUrl: String) = apply { this.qrCodeUrl = qrCodeUrl }
    ...
    private constructor(
         ...
         */
        @JsonProperty("line2_text") fun line2Text(): String? = line2Text
        ...
        class Builder {
            ...
            fun line2Text(line2Text: String) = apply { this.line2Text = line2Text }
            ...
            /**
             * Uppercase ISO 3166-2 two character abbreviation for US and CA. Optional with a limit
             * of 24 characters for other countries.
             */
