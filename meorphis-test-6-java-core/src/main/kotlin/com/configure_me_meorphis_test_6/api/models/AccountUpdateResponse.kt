...
@NoAutoDetect
class AccountUpdateResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AccountUpdateResponse{spendLimit=$spendLimit, state=$state, token=$token, authRuleTokens=$authRuleTokens, verificationAddress=$verificationAddress, accountHolder=$accountHolder, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(accountUpdateResponse: AccountUpdateResponse) = apply {
            this.spendLimit = accountUpdateResponse.spendLimit
            this.state = accountUpdateResponse.state
            this.token = accountUpdateResponse.token
            this.authRuleTokens = accountUpdateResponse.authRuleTokens
            this.verificationAddress = accountUpdateResponse.verificationAddress
            this.accountHolder = accountUpdateResponse.accountHolder
        ...
        fun build(): AccountUpdateResponse = AccountUpdateResponse(
            spendLimit,
            state,
            token,
