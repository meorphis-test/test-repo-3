...
private constructor(
    ...
    override fun toString() =
        "StatusGetStatusResponse{message=$message, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): StatusGetStatusResponse =
            StatusGetStatusResponse(message, additionalProperties.toUnmodifiable())
    }
}
