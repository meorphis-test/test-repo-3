...
@JsonDeserialize(builder = CardFinancialTransactionGetFinancialTransactionByTokenResponse.Builder::class)
@NoAutoDetect
class CardFinancialTransactionGetFinancialTransactionByTokenResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _pendingAmount() = pendingAmount
    ...
    @ExcludeMissing
    fun _updated() = updated

    @JsonAnyGetter
    @ExcludeMissing
    fun _additionalProperties(): Map<String, JsonValue> = additionalProperties

    fun validate(): CardFinancialTransactionGetFinancialTransactionByTokenResponse = apply {
        if (!validated) {
          category()
          created()
          currency()
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CardFinancialTransactionGetFinancialTransactionByTokenResponse &&
    ...
    override fun toString() = "CardFinancialTransactionGetFinancialTransactionByTokenResponse{category=$category, created=$created, currency=$currency, descriptor=$descriptor, events=$events, pendingAmount=$pendingAmount, result=$result, settledAmount=$settledAmount, status=$status, token=$token, updated=$updated, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(cardFinancialTransactionGetFinancialTransactionByTokenResponse: CardFinancialTransactionGetFinancialTransactionByTokenResponse) = apply {
            this.category = cardFinancialTransactionGetFinancialTransactionByTokenResponse.category
            this.created = cardFinancialTransactionGetFinancialTransactionByTokenResponse.created
            this.currency = cardFinancialTransactionGetFinancialTransactionByTokenResponse.currency
            this.descriptor = cardFinancialTransactionGetFinancialTransactionByTokenResponse.descriptor
            this.events = cardFinancialTransactionGetFinancialTransactionByTokenResponse.events
            this.pendingAmount = cardFinancialTransactionGetFinancialTransactionByTokenResponse.pendingAmount
            this.result = cardFinancialTransactionGetFinancialTransactionByTokenResponse.result
            this.settledAmount = cardFinancialTransactionGetFinancialTransactionByTokenResponse.settledAmount
            this.status = cardFinancialTransactionGetFinancialTransactionByTokenResponse.status
            this.token = cardFinancialTransactionGetFinancialTransactionByTokenResponse.token
            this.updated = cardFinancialTransactionGetFinancialTransactionByTokenResponse.updated
            additionalProperties(cardFinancialTransactionGetFinancialTransactionByTokenResponse.additionalProperties)
        }
        ...
        fun build(): CardFinancialTransactionGetFinancialTransactionByTokenResponse = CardFinancialTransactionGetFinancialTransactionByTokenResponse(
            category,
            created,
            currency,
            descriptor,
    ...
    class Category @JsonCreator private constructor(private val value: JsonField<String>, ) {
        ...
        fun known(): Known = when (this) {
            ...
            else -> throw MeorphisTest6InvalidDataException("Unknown Category: $value")
        }
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Result @JsonCreator private constructor(private val value: JsonField<String>, ) {
            ...
            fun known(): Known = when (this) {
                ...
                else -> throw MeorphisTest6InvalidDataException("Unknown Result: $value")
            }
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>, ) {
            ...
            companion object {
                ...
                @JvmField val ACH_ORIGINATION_PENDING = Type(JsonField.of("ACH_ORIGINATION_PENDING"))

                @JvmField val ACH_ORIGINATION_RELEASED = Type(JsonField.of("ACH_ORIGINATION_RELEASED"))
                ...
                @JvmField val TRANSFER_INSUFFICIENT_FUNDS = Type(JsonField.of("TRANSFER_INSUFFICIENT_FUNDS"))
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>, ) {
        ...
        fun known(): Known = when (this) {
            ...
            VOIDED -> Known.VOIDED
            else -> throw MeorphisTest6InvalidDataException("Unknown Status: $value")
        }
