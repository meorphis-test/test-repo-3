...
@JsonDeserialize(
    builder = CardFinancialTransactionGetFinancialTransactionByTokenResponse.Builder::class
)
@NoAutoDetect
class CardFinancialTransactionGetFinancialTransactionByTokenResponse
private constructor(
    ...
    override fun toString() =
        "CardFinancialTransactionGetFinancialTransactionByTokenResponse{category=$category, created=$created, currency=$currency, descriptor=$descriptor, events=$events, pendingAmount=$pendingAmount, result=$result, settledAmount=$settledAmount, status=$status, token=$token, updated=$updated, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.descriptor =
                cardFinancialTransactionGetFinancialTransactionByTokenResponse.descriptor
            this.events = cardFinancialTransactionGetFinancialTransactionByTokenResponse.events
            this.pendingAmount =
                cardFinancialTransactionGetFinancialTransactionByTokenResponse.pendingAmount
            this.result = cardFinancialTransactionGetFinancialTransactionByTokenResponse.result
            this.settledAmount =
                cardFinancialTransactionGetFinancialTransactionByTokenResponse.settledAmount
            ...
            additionalProperties(
                cardFinancialTransactionGetFinancialTransactionByTokenResponse.additionalProperties
            )
        }
        ...
        fun build(): CardFinancialTransactionGetFinancialTransactionByTokenResponse =
            CardFinancialTransactionGetFinancialTransactionByTokenResponse(
                category,
                created,
                currency,
