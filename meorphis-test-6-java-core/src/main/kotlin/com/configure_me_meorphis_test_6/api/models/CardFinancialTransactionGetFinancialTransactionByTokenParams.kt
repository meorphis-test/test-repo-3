...
class CardFinancialTransactionGetFinancialTransactionByTokenParams
constructor(
    ...
    override fun toString() =
        "CardFinancialTransactionGetFinancialTransactionByTokenParams{cardToken=$cardToken, financialTransactionToken=$financialTransactionToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            cardFinancialTransactionGetFinancialTransactionByTokenParams:
                CardFinancialTransactionGetFinancialTransactionByTokenParams
        ) = apply {
            ...
            this.financialTransactionToken =
                cardFinancialTransactionGetFinancialTransactionByTokenParams
                    .financialTransactionToken
            additionalQueryParams(
                cardFinancialTransactionGetFinancialTransactionByTokenParams.additionalQueryParams
            )
            additionalHeaders(
                cardFinancialTransactionGetFinancialTransactionByTokenParams.additionalHeaders
            )
        }
        ...
        fun build(): CardFinancialTransactionGetFinancialTransactionByTokenParams =
            CardFinancialTransactionGetFinancialTransactionByTokenParams(
