...
class AccountCreditConfigurationListParams
constructor(
    ...
    override fun toString() =
        "AccountCreditConfigurationListParams{accountToken=$accountToken, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            accountCreditConfigurationListParams: AccountCreditConfigurationListParams
        ) = apply {
        ...
        fun build(): AccountCreditConfigurationListParams =
            AccountCreditConfigurationListParams(
