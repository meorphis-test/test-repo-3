...
@JsonDeserialize(builder = CardUpdateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(cardUpdateResponse: CardUpdateResponse) = apply {
            this.created = cardUpdateResponse.created
            this.cvv = cardUpdateResponse.cvv
            this.funding = cardUpdateResponse.funding
            this.expMonth = cardUpdateResponse.expMonth
            this.expYear = cardUpdateResponse.expYear
            this.hostname = cardUpdateResponse.hostname
            this.lastFour = cardUpdateResponse.lastFour
            this.memo = cardUpdateResponse.memo
            this.pan = cardUpdateResponse.pan
            this.spendLimit = cardUpdateResponse.spendLimit
            this.spendLimitDuration = cardUpdateResponse.spendLimitDuration
            this.state = cardUpdateResponse.state
            this.authRuleTokens = cardUpdateResponse.authRuleTokens
            this.token = cardUpdateResponse.token
            this.type = cardUpdateResponse.type
            this.digitalCardArtToken = cardUpdateResponse.digitalCardArtToken
            additionalProperties(cardUpdateResponse.additionalProperties)
        }
