...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(cardCreateResponse: CardCreateResponse) = apply {
            this.created = cardCreateResponse.created
            this.cvv = cardCreateResponse.cvv
            this.funding = cardCreateResponse.funding
            this.expMonth = cardCreateResponse.expMonth
            this.expYear = cardCreateResponse.expYear
            this.hostname = cardCreateResponse.hostname
            this.lastFour = cardCreateResponse.lastFour
            this.memo = cardCreateResponse.memo
            this.pan = cardCreateResponse.pan
            this.spendLimit = cardCreateResponse.spendLimit
            this.spendLimitDuration = cardCreateResponse.spendLimitDuration
            this.state = cardCreateResponse.state
            this.authRuleTokens = cardCreateResponse.authRuleTokens
            this.token = cardCreateResponse.token
            this.type = cardCreateResponse.type
            this.digitalCardArtToken = cardCreateResponse.digitalCardArtToken
