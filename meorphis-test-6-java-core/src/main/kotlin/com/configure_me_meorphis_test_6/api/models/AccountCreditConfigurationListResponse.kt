...
@NoAutoDetect
class AccountCreditConfigurationListResponse
private constructor(
    ...
    override fun toString() =
        "AccountCreditConfigurationListResponse{collectionsConfiguration=$collectionsConfiguration, creditLimit=$creditLimit, token=$token, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            accountCreditConfigurationListResponse: AccountCreditConfigurationListResponse
        ) = apply {
            this.collectionsConfiguration =
                accountCreditConfigurationListResponse.collectionsConfiguration
        ...
        fun build(): AccountCreditConfigurationListResponse =
