...
@JsonDeserialize(builder = AccountCreditConfigurationListResponse.Builder::class)
@NoAutoDetect
class AccountCreditConfigurationListResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    fun validate(): AccountCreditConfigurationListResponse = apply {
        if (!validated) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AccountCreditConfigurationListResponse &&
    ...
    override fun toString() = "AccountCreditConfigurationListResponse{collectionsConfiguration=$collectionsConfiguration, creditLimit=$creditLimit, token=$token, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(accountCreditConfigurationListResponse: AccountCreditConfigurationListResponse) = apply {
            this.collectionsConfiguration = accountCreditConfigurationListResponse.collectionsConfiguration
            this.creditLimit = accountCreditConfigurationListResponse.creditLimit
            this.token = accountCreditConfigurationListResponse.token
            additionalProperties(accountCreditConfigurationListResponse.additionalProperties)
        }
        ...
        fun build(): AccountCreditConfigurationListResponse = AccountCreditConfigurationListResponse(
            collectionsConfiguration,
            creditLimit,
            token,
