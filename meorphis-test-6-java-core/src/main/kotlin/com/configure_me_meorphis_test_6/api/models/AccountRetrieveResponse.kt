...
private constructor(
    ...
    override fun toString() =
        "AccountRetrieveResponse{spendLimit=$spendLimit, state=$state, token=$token, authRuleTokens=$authRuleTokens, verificationAddress=$verificationAddress, accountHolder=$accountHolder, additionalProperties=$additionalProperties}"
