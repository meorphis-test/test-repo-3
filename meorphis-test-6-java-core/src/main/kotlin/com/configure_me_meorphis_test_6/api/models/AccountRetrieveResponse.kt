...
@JsonDeserialize(builder = AccountRetrieveResponse.Builder::class)
@NoAutoDetect
class AccountRetrieveResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "AccountRetrieveResponse{spendLimit=$spendLimit, state=$state, token=$token, authRuleTokens=$authRuleTokens, verificationAddress=$verificationAddress, accountHolder=$accountHolder, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            this.spendLimit = accountRetrieveResponse.spendLimit
            this.state = accountRetrieveResponse.state
            this.token = accountRetrieveResponse.token
            this.authRuleTokens = accountRetrieveResponse.authRuleTokens
            this.verificationAddress = accountRetrieveResponse.verificationAddress
            this.accountHolder = accountRetrieveResponse.accountHolder
            additionalProperties(accountRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): AccountRetrieveResponse = AccountRetrieveResponse(
            spendLimit,
            state,
            token,
    ...
    @NoAutoDetect
    class SpendLimit private constructor(
    ...
    @NoAutoDetect
    class AccountHolder private constructor(
      private val token: JsonField<String>,
    ...
    @NoAutoDetect
    class VerificationAddress private constructor(
