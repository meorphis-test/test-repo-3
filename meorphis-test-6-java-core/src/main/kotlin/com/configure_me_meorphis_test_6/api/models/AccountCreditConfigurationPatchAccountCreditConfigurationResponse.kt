...
@JsonDeserialize(builder = AccountCreditConfigurationPatchAccountCreditConfigurationResponse.Builder::class)
@NoAutoDetect
class AccountCreditConfigurationPatchAccountCreditConfigurationResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    fun collectionsConfiguration(): Optional<CollectionsConfiguration> = Optional.ofNullable(collectionsConfiguration.getNullable("collections_configuration"))
    ...
    override fun toString() = "AccountCreditConfigurationPatchAccountCreditConfigurationResponse{collectionsConfiguration=$collectionsConfiguration, creditLimit=$creditLimit, token=$token, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(accountCreditConfigurationPatchAccountCreditConfigurationResponse: AccountCreditConfigurationPatchAccountCreditConfigurationResponse) = apply {
            this.collectionsConfiguration = accountCreditConfigurationPatchAccountCreditConfigurationResponse.collectionsConfiguration
            this.creditLimit = accountCreditConfigurationPatchAccountCreditConfigurationResponse.creditLimit
            this.token = accountCreditConfigurationPatchAccountCreditConfigurationResponse.token
            additionalProperties(accountCreditConfigurationPatchAccountCreditConfigurationResponse.additionalProperties)
        }

        fun collectionsConfiguration(collectionsConfiguration: CollectionsConfiguration) = collectionsConfiguration(JsonField.of(collectionsConfiguration))

        @JsonProperty("collections_configuration")
        @ExcludeMissing
        fun collectionsConfiguration(collectionsConfiguration: JsonField<CollectionsConfiguration>) = apply {
        ...
        fun build(): AccountCreditConfigurationPatchAccountCreditConfigurationResponse = AccountCreditConfigurationPatchAccountCreditConfigurationResponse(
            collectionsConfiguration,
            creditLimit,
            token,
    ...
    @NoAutoDetect
    class CollectionsConfiguration private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun externalBankAccountToken(): Optional<String> = Optional.ofNullable(externalBankAccountToken.getNullable("external_bank_account_token"))
        ...
        @ExcludeMissing
        fun _billingPeriod() = billingPeriod
        ...
        @ExcludeMissing
        fun _paymentPeriod() = paymentPeriod
        ...
        override fun toString() = "CollectionsConfiguration{billingPeriod=$billingPeriod, externalBankAccountToken=$externalBankAccountToken, paymentPeriod=$paymentPeriod, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            /** The external bank account token to use for auto-collections */
            fun externalBankAccountToken(externalBankAccountToken: String) = externalBankAccountToken(JsonField.of(externalBankAccountToken))
            ...
            fun build(): CollectionsConfiguration = CollectionsConfiguration(
                billingPeriod,
                externalBankAccountToken,
                paymentPeriod,
                additionalProperties.toUnmodifiable(),
