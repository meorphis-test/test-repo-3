...
@NoAutoDetect
class CardProvisionPostProvisionResponse private constructor(private val provisioningPayload: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "CardProvisionPostProvisionResponse{provisioningPayload=$provisioningPayload, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(cardProvisionPostProvisionResponse: CardProvisionPostProvisionResponse) = apply {
        ...
        fun build(): CardProvisionPostProvisionResponse = CardProvisionPostProvisionResponse(provisioningPayload, additionalProperties.toUnmodifiable())
    }
}
