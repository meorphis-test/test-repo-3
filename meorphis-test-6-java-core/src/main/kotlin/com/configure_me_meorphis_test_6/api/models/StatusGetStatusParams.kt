...
class StatusGetStatusParams constructor(private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is StatusGetStatusParams &&
    ...
    override fun toString() = "StatusGetStatusParams{additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(statusGetStatusParams: StatusGetStatusParams) = apply {
            additionalQueryParams(statusGetStatusParams.additionalQueryParams)
            additionalHeaders(statusGetStatusParams.additionalHeaders)
        }
        ...
        fun build(): StatusGetStatusParams = StatusGetStatusParams(additionalQueryParams.mapValues { it.value.toUnmodifiable() }.toUnmodifiable(), additionalHeaders.mapValues { it.value.toUnmodifiable() }.toUnmodifiable())
    }
}
