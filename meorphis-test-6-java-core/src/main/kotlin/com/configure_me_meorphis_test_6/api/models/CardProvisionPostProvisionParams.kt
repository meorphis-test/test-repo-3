...
class CardProvisionPostProvisionParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class CardProvisionPostProvisionBody internal constructor(
      private val certificate: String?,
      private val digitalWallet: DigitalWallet?,
      private val nonce: String?,
      private val nonceSignature: String?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "CardProvisionPostProvisionBody{certificate=$certificate, digitalWallet=$digitalWallet, nonce=$nonce, nonceSignature=$nonceSignature, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(cardProvisionPostProvisionBody: CardProvisionPostProvisionBody) = apply {
            ...
            fun build(): CardProvisionPostProvisionBody = CardProvisionPostProvisionBody(
                certificate,
                digitalWallet,
                nonce,
                nonceSignature,
    ...
    override fun toString() = "CardProvisionPostProvisionParams{cardToken=$cardToken, certificate=$certificate, digitalWallet=$digitalWallet, nonce=$nonce, nonceSignature=$nonceSignature, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(cardProvisionPostProvisionParams: CardProvisionPostProvisionParams) = apply {
        ...
        fun build(): CardProvisionPostProvisionParams = CardProvisionPostProvisionParams(
