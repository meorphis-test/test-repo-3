...
@JsonDeserialize(builder = CardRetrieveResponse.Builder::class)
@NoAutoDetect
...
private constructor(
     ...
     * [acme.com/contact](https://acme.com/contact) for more information.
     ...
     * tokenization. This artwork must be approved by Mastercard and configured by Acme to use. See
    ...
    class Builder {
        ...
        internal fun from(cardRetrieveResponse: CardRetrieveResponse) = apply {
            this.created = cardRetrieveResponse.created
            this.cvv = cardRetrieveResponse.cvv
            this.funding = cardRetrieveResponse.funding
            this.expMonth = cardRetrieveResponse.expMonth
            this.expYear = cardRetrieveResponse.expYear
            this.hostname = cardRetrieveResponse.hostname
            this.lastFour = cardRetrieveResponse.lastFour
            this.memo = cardRetrieveResponse.memo
            this.pan = cardRetrieveResponse.pan
            this.spendLimit = cardRetrieveResponse.spendLimit
            this.spendLimitDuration = cardRetrieveResponse.spendLimitDuration
            this.state = cardRetrieveResponse.state
            this.authRuleTokens = cardRetrieveResponse.authRuleTokens
            this.token = cardRetrieveResponse.token
            this.type = cardRetrieveResponse.type
            this.digitalCardArtToken = cardRetrieveResponse.digitalCardArtToken
            additionalProperties(cardRetrieveResponse.additionalProperties)
        }
        ...
        /**
         * Specifies the digital card art to be displayed in the user’s digital wallet after
         * tokenization. This artwork must be approved by Mastercard and configured by Acme to use.
         * See
         * [Flexible Card Art Guide](https://docs.acme.com/docs/about-digital-wallets#flexible-card-art)
         * .
         */
    ...
    private constructor(
        ...
        /**
         * An RFC 3339 string representing when this funding source was added to the Acme account.
        ...
        override fun toString() =
            "Funding{accountName=$accountName, created=$created, lastFour=$lastFour, nickname=$nickname, state=$state, token=$token, type=$type, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(funding: Funding) = apply {
                this.accountName = funding.accountName
                this.created = funding.created
                this.lastFour = funding.lastFour
                this.nickname = funding.nickname
                this.state = funding.state
        ...
        fun known(): Known =
            when (this) {
                ...
                TRANSACTION -> Known.TRANSACTION
                    ...
                    throw MeorphisTest6InvalidDataException("Unknown SpendLimitDuration: $value")
            }
