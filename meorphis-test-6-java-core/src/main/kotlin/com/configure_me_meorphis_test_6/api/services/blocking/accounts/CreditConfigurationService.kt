...
interface CreditConfigurationService {
    ...
    @JvmOverloads
    fun list(params: AccountCreditConfigurationListParams, requestOptions: RequestOptions = RequestOptions.none()): AccountCreditConfigurationListResponse

    /** Update a Business Accounts credit configuration */
    @JvmOverloads
    fun patchAccountCreditConfiguration(params: AccountCreditConfigurationPatchAccountCreditConfigurationParams, requestOptions: RequestOptions = RequestOptions.none()): AccountCreditConfigurationPatchAccountCreditConfigurationResponse
}
