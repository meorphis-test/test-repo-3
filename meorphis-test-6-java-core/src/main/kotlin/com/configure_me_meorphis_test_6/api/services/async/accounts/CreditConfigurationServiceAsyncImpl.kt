...
class CreditConfigurationServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CreditConfigurationServiceAsync {
    ...
    override fun list(params: AccountCreditConfigurationListParams, requestOptions: RequestOptions): CompletableFuture<AccountCreditConfigurationListResponse> {
    ...
    override fun patchAccountCreditConfiguration(params: AccountCreditConfigurationPatchAccountCreditConfigurationParams, requestOptions: RequestOptions): CompletableFuture<AccountCreditConfigurationPatchAccountCreditConfigurationResponse> {
      val request = HttpRequest.builder()
