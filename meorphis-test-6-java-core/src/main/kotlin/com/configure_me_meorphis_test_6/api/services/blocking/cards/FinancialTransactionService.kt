...
interface FinancialTransactionService {
    ...
    @JvmOverloads
    fun getFinancialTransactionByToken(params: CardFinancialTransactionGetFinancialTransactionByTokenParams, requestOptions: RequestOptions = RequestOptions.none()): CardFinancialTransactionGetFinancialTransactionByTokenResponse
}
