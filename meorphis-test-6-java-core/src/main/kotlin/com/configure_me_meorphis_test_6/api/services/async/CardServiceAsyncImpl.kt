...
class CardServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : CardServiceAsync {
    ...
    private val financialTransactions: FinancialTransactionServiceAsync by lazy { FinancialTransactionServiceAsyncImpl(clientOptions) }

    private val provisions: ProvisionServiceAsync by lazy { ProvisionServiceAsyncImpl(clientOptions) }
    ...
    override fun retrieve(params: CardRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CardRetrieveResponse> {
      val request = HttpRequest.builder()
     ...
     * undone._
     */
    override fun update(params: CardUpdateParams, requestOptions: RequestOptions): CompletableFuture<CardUpdateResponse> {
      val request = HttpRequest.builder()
