...
interface CreditConfigurationServiceAsync {
    ...
    @JvmOverloads
    fun list(params: AccountCreditConfigurationListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AccountCreditConfigurationListResponse>

    /** Update a Business Accounts credit configuration */
    @JvmOverloads
    fun patchAccountCreditConfiguration(params: AccountCreditConfigurationPatchAccountCreditConfigurationParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AccountCreditConfigurationPatchAccountCreditConfigurationResponse>
}
