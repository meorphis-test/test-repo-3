...
class StatusServiceImpl constructor(private val clientOptions: ClientOptions, ) : StatusService {
    ...
    /** API status check */
    override fun getStatus(params: StatusGetStatusParams, requestOptions: RequestOptions): StatusGetStatusResponse {
