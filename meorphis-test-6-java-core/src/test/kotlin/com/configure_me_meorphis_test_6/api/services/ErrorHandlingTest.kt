...
class ErrorHandlingTest {
    ...
    private val MEORPHIS_TEST6_ERROR: MeorphisTest6Error = MeorphisTest6Error.builder().putAdditionalProperty("key", JsonString.of("value")).build()

    private lateinit var client: MeorphisTest6Client

    @BeforeEach
    fun beforeEach(wmRuntimeInfo: WireMockRuntimeInfo) {
      client = MeorphisTest6OkHttpClient.builder()
    ...
    fun accountsRetrieve200() {
      ...
      val expected = AccountRetrieveResponse.builder()
    ...
    fun accountsRetrieve400() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(400).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve401() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(401).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertUnauthorized(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve403() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(403).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertPermissionDenied(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve404() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(404).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertNotFound(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve422() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(422).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertUnprocessableEntity(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve429() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(429).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertRateLimit(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun accountsRetrieve500() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(500).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) })
          .satisfies({ e -> assertInternalServer(e, ImmutableListMultimap.of("Foo", "Bar"), MEORPHIS_TEST6_ERROR) })
    }
    ...
    fun unexpectedStatusCode() {
      ...
      stubFor(get(anyUrl())
          .willReturn(status(999).withHeader("Foo", "Bar").withBody(toJson(MEORPHIS_TEST6_ERROR))))

      assertThatThrownBy({ client.accounts().retrieve(params) }).satisfies({ e -> assertUnexpectedStatusCodeException(e, 999, ImmutableListMultimap.of("Foo", "Bar"), toJson(MEORPHIS_TEST6_ERROR)) })
    }
    ...
    fun invalidBody() {
      ...
      assertThatThrownBy({ client.accounts().retrieve(params) }).satisfies({ e -> assertThat(e)
    ...
    fun invalidErrorBody() {
      ...
      assertThatThrownBy({ client.accounts().retrieve(params) }).satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of(), MeorphisTest6Error.builder().build()) })
    }
    ...
    private fun assertBadRequest(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertUnauthorized(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertPermissionDenied(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertNotFound(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertUnprocessableEntity(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertRateLimit(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
    ...
    private fun assertInternalServer(throwable: Throwable, headers: ListMultimap<String, String>, error: MeorphisTest6Error) {
      assertThat(throwable)
