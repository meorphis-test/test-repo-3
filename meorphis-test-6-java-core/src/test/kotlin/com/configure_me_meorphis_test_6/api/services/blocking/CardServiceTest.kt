...
import com.configure_me_meorphis_test_6.api.services.blocking.CardService
...
class CardServiceTest {
    ...
    fun callCreate() {
      ...
      val cardCreateResponse = cardService.create(CardCreateParams.builder()
    ...
    fun callRetrieve() {
      val client = MeorphisTest6OkHttpClient.builder()
          ...
          .build()
      val cardService = client.cards()
      val cardRetrieveResponse = cardService.retrieve(CardRetrieveParams.builder()
    ...
    fun callUpdate() {
      val client = MeorphisTest6OkHttpClient.builder()
          ...
          .build()
      val cardService = client.cards()
      val cardUpdateResponse = cardService.update(CardUpdateParams.builder()
          .cardToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
