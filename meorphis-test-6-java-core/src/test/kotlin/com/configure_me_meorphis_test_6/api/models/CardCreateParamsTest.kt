...
import com.configure_me_meorphis_test_6.api.models.CardCreateParams.CardCreateBody
...
class CardCreateParamsTest {
    ...
    fun createCardCreateParams() {
      CardCreateParams.builder()
          ...
          .carrier(CardCreateParams.Carrier.builder()
              .qrCodeUrl("string")
              .build())
          ...
          .pin("string")
          .productId("1")
          .shippingAddress(CardCreateParams.ShippingAddress.builder()
    ...
    fun getBody() {
      ...
      assertThat(body.carrier()).isEqualTo(CardCreateParams.Carrier.builder()
          .qrCodeUrl("string")
          .build())
      ...
      assertThat(body.shippingAddress()).isEqualTo(CardCreateParams.ShippingAddress.builder()
          .address1("5 Broad Street")
          .city("NEW YORK")
          .country("USA")
          .firstName("Michael")
      ...
      assertThat(body.spendLimitDuration()).isEqualTo(CardCreateParams.SpendLimitDuration.ANNUALLY)
