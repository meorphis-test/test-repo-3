...
class AccountUpdateResponseTest {
    ...
    fun createAccountUpdateResponse() {
      val accountUpdateResponse = AccountUpdateResponse.builder()
          ...
          .spendLimit(AccountUpdateResponse.SpendLimit.builder()
              .daily(123L)
              .lifetime(123L)
              .monthly(123L)
              .build())
          .state(AccountUpdateResponse.State.ACTIVE)
          .accountHolder(AccountUpdateResponse.AccountHolder.builder()
          ...
          .verificationAddress(AccountUpdateResponse.VerificationAddress.builder()
      ...
      assertThat(accountUpdateResponse.spendLimit()).isEqualTo(AccountUpdateResponse.SpendLimit.builder()
          .daily(123L)
          .lifetime(123L)
          .monthly(123L)
          .build())
      assertThat(accountUpdateResponse.state()).isEqualTo(AccountUpdateResponse.State.ACTIVE)
      assertThat(accountUpdateResponse.accountHolder()).contains(AccountUpdateResponse.AccountHolder.builder()
          .token("95e5f1b7-cfd5-4520-aa3c-2451bab8608d")
          .businessAccountToken("e87db14a-4abf-4901-adad-5d5c9f46aff2")
          .email("jack@acme.com")
          .phoneNumber("+12124007676")
      ...
      assertThat(accountUpdateResponse.verificationAddress()).contains(AccountUpdateResponse.VerificationAddress.builder()
          .address1("124 Old Forest Way")
          .city("Seattle")
          .country("USA")
          .postalCode("98109")
