...
import com.configure_me_meorphis_test_6.api.models.AccountCreditConfigurationPatchAccountCreditConfigurationParams.AccountCreditConfigurationPatchAccountCreditConfigurationBody
...
class AccountCreditConfigurationPatchAccountCreditConfigurationParamsTest {
    ...
    @Test
    fun getBody() {
      val params = AccountCreditConfigurationPatchAccountCreditConfigurationParams.builder()
          .accountToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .billingPeriod(123L)
          .creditLimit(123L)
          .externalBankAccountToken("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(body.externalBankAccountToken()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
