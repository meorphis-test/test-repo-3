...
class AccountCreditConfigurationPatchAccountCreditConfigurationResponseTest {
    ...
    fun createAccountCreditConfigurationPatchAccountCreditConfigurationResponse() {
        val accountCreditConfigurationPatchAccountCreditConfigurationResponse =
            AccountCreditConfigurationPatchAccountCreditConfigurationResponse.builder()
        ...
        assertThat(accountCreditConfigurationPatchAccountCreditConfigurationResponse.token())
        ...
        assertThat(accountCreditConfigurationPatchAccountCreditConfigurationResponse.creditLimit())
            .contains(123L)
    }
}
