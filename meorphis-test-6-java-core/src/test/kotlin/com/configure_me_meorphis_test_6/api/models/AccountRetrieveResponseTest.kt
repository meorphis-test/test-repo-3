...
class AccountRetrieveResponseTest {
    ...
    fun createAccountRetrieveResponse() {
        ...
        assertThat(accountRetrieveResponse.token())
            .isEqualTo("b68b7424-aa69-4cbc-a946-30d90181b621")
        assertThat(accountRetrieveResponse.spendLimit())
            .isEqualTo(
                AccountRetrieveResponse.SpendLimit.builder()
                    .daily(123L)
                    .lifetime(123L)
        ...
        assertThat(accountRetrieveResponse.accountHolder())
            .contains(
                AccountRetrieveResponse.AccountHolder.builder()
                    .token("95e5f1b7-cfd5-4520-aa3c-2451bab8608d")
                    .businessAccountToken("e87db14a-4abf-4901-adad-5d5c9f46aff2")
        ...
        assertThat(accountRetrieveResponse.verificationAddress())
            .contains(
                AccountRetrieveResponse.VerificationAddress.builder()
                    .address1("124 Old Forest Way")
                    .city("Seattle")
