...
import com.configure_me_meorphis_test_6.api.errors.MeorphisTest6IoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(
        ...
        return try {
            ...
            throw MeorphisTest6IoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(MeorphisTest6IoException("Request failed", e))
                }
            }
        )
