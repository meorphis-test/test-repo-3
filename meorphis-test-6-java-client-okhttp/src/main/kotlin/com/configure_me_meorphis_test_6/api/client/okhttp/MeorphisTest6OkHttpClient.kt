...
import com.configure_me_meorphis_test_6.api.client.MeorphisTest6ClientImpl

class MeorphisTest6OkHttpClient private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        fun fromEnv(): MeorphisTest6Client = builder().fromEnv().build()
    }
    ...
    class Builder {
        ...
        fun build(): MeorphisTest6Client {
          return MeorphisTest6ClientImpl(clientOptions
