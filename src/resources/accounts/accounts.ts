...
import * as AccountsAPI from 'meorphis-test-3-hp2m8u/resources/accounts/accounts';
import * as CreditConfigurationAPI from 'meorphis-test-3-hp2m8u/resources/accounts/credit-configuration';
